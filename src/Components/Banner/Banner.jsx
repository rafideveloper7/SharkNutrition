...
function Banner() {
    return (
        <section id="banner" className='h-150 text-center p-5 flex justify-center items-center'>
            <div className='bg-[#0000005b] p-5 max-w-200 mx-auto'>
                <h1 className='text-4xl font-semibold mb-3'>Welcome to Shark Nutrition</h1>
