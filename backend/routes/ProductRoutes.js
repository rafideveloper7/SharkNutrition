...
router.put(
  ...
  async (req, res) => {
    try {
      ...
      if (updateData.servings) updateData.servings = JSON.parse(updateData.servings);
      ...
      if (updateData.category) updateData.category = updateData.category.toLowerCase().trim();
