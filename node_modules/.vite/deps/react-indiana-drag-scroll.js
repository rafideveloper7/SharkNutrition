  ...
  !(function() {
    ...
    function n2() {
      for (var t3 = [], o2 = 0; o2 < arguments.length; o2++) {
        ...
        if (r2) {
          var i2 = typeof r2;
          if ("string" === i2 || "number" === i2) t3.push(r2);
          else if (Array.isArray(r2) && r2.length) {
            var s2 = n2.apply(null, r2);
            s2 && t3.push(s2);
          } else if ("object" === i2) for (var l2 in r2) e2.call(r2, l2) && r2[l2] && t3.push(l2);
        }
      }
      return t3.join(" ");
    }
...
var p = (function(e2) {
  function o2(n2) {
    ...
    return o3.onEndScroll = function() {
      ...
      if (o3.isDraggable(t2.target)) if (o3.internal = true, e3 && o3.scrolling) o3.pressed = true;
      else {
        var n3 = t2.touches[0];
...
react-indiana-drag-scroll/dist/index.es.js:
  ...
  *)
*/
//# sourceMappingURL=react-indiana-drag-scroll.js.map
