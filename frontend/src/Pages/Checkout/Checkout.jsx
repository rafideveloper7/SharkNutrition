...
function Checkout() {
    ...
    function handleChange(e) {
        ...
        if (name === "couponCode") {
            setCouponMessage({ type: "", text: "" }); // Clear message on new input
            setDiscount(0); // Reset discount if user changes code
        }
    }
    ...
    async function applyCoupon() {
        ...
        try {
            ...
            if (data.success) {
                ...
                setCouponMessage({ type: "success", text: `Discount of Rs. ${data.discount.toFixed(2)} applied!` });
                ...
                <div className="grid md:grid-cols-2 gap-10">
                    ...
                    >
                        ...
                        <div>
                            ...
                            {couponMessage.text && (
                                <p className={`text-sm mt-2 ${couponMessage.type === 'success' ? 'text-green-400' : 'text-red-400'
                                    }`}
                                >
                                    {couponMessage.text}
                                </p>
